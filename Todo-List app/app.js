// UI DOM Selectors
const addButton_1 = document.querySelector(".add-link");
const popup = document.querySelector(".add-popup");
const listPopup = document.querySelector(".add-list-popup");
const closePopupBtn_1 = document.querySelector(".popup-close");
const closeListPopupBtn_1 = document.querySelector(".list-popup-close");
const blur = document.querySelector("#blur");
const newListField = document.querySelector(".title-field");
const addCard_1 = document.querySelector("#addCard");
...
// UI Event Listener
addButton_1.addEventListener("click", displayPopup);
closePopupBtn_1.addEventListener("click", closePopup);
closeListPopupBtn_1.addEventListener("click", closeListPopup);
addCard_1.addEventListener("click", AddNewCard);
